...
from analyzers.tweets_analyzer import TweetAnalyzer
from analyzers.tweets_searcher import TweetsSearch
...
def main():
    ...
    analyzer = TweetAnalyzer(cleaned_df)

    # Perform analysis
    hashtag_counts = analyzer.count_hashtags()
    retweet_count = analyzer.count_retweets()
    verified_user_count = analyzer.count_user_verified()
    source_counts = analyzer.count_sources()
    avg_followers_per_location = analyzer.avg_followers_per_location()
